...
<head>
    ...
    <title>Inicio de sesión - AcademiaHub</title>
</head>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item sign-in-li">
                        <button class="btn btn-success sign-in-btn" type="button" onclick="window.location.href='login.php'">Iniciar sesión</button>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-center mt-3 registrer">¿No tienes una cuenta? <a href="../Registro/Registro.php">Regístrate aquí</a></p>
                        </div>
                    </div>
                </div>
            </div>
