...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Comunidad.css">
    <title>Comunidad - Academia Hub</title>
</head>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../ComoFunciona/ComoFunciona.php">Cómo Funciona</a>
                    </li>
    ...
    <main class="main">
        <section class="community-cover-container">
            <div class="overlay"></div>
            <div class="community-cover-content">
                <h1>Únete a Nuestra Comunidad</h1>
                <p>Conecta con estudiantes apasionados, comparte experiencias y ayuda a otros en su viaje educativo.
                    ¡Descubre una comunidad vibrante y colaborativa!</p>
            </div>
        </section>
        ...
        <br>
        <h2 class="container-lg">Seminarios</h2>
        ...
        <section class="courses-section container">
            ...
            <div class="row">
                <?php foreach ($seminarios as $seminario) { ?>
                    <div class="col-md-4">
                        <div class="card">
                            <img src="../Admin/AdminComunidad/images/<?php echo $seminario['imagen']; ?>"
                                alt="Imagen Seminario" style="width: 100%; border-radius: 5px;">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <?php echo $seminario['nombre']; ?>
                                </h5>
                                <p class="card-text">Orador:
                                    <?php echo $seminario['orador']; ?>
                                </p>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal<?php echo $seminario['id_seminario']; ?>">
                                    Ver Detalles
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Modal para cada seminario -->
                    <div class="modal fade" id="exampleModal<?php echo $seminario['id_seminario']; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Detalles del Seminario</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <h5>Nombre del Seminario:
                                        <?php echo $seminario['nombre']; ?>
                                    </h5>
                                    <p>Descripción:
